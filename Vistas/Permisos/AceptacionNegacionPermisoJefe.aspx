<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AceptacionNegacionPermisoJefe.aspx.cs" Inherits="ControlEmpresarial.Vistas.Permisos.AceptacionNegacionPermisoJefe" %>
...
<main>
    ...
    <section class="seccion-formulario">
        <div class="tarjeta-formulario" style="max-width: 700px; margin: 0 auto;">
               <h2><span class="fuente-delgada">Solicitud</span><br/><span class="fuente-gruesa">Dinamic Name</span></h2>
            <br />
            <p>Permiso</p>
            <br />
            <label>Tipo:</label>
            ...
            <asp:Label CssClass="">Dinamic</asp:Label>
            <br />
