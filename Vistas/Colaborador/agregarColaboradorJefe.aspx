<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="agregarColaboradorJefe.aspx.cs" Inherits="ControlEmpresarial.Vistas.Colaborador.agregarColaboradorJefe" %>
<!DOCTYPE html>
<html lang="es">
   <head runat="server">
      <meta charset="UTF-8">
            ...
            <nav>
               <ul>
                  <li class="has-submenu">
                     ...
                     <ul class="submenu">
                        <li><a href="../Permisos/agregarColaboradorJefe.aspx">Agregar Colaborador</a></li>
                     </ul>
                  </li>
                  <li class="has-submenu">
                     <a href="#">Permisos</a>
