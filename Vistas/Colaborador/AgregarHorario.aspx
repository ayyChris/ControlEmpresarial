<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgregarHorario.aspx.cs" Inherits="ControlEmpresarial.Vistas.Colaborador.AgregarHorario" %>
         ...
         <main>
            <section class="seccion-formulario">
               <div class="tarjeta-formulario-login" style="max-width: 700px; margin: 0 auto;">
                  ...
                  <br />
                  <div>
                     <label class="fuente-delgada" for="cedula">Jornada</label>
                        <asp:DropDownList ID="ddlDepartamento" runat="server"></asp:DropDownList>
                  </div>
                  <br />
                   <div>
                       <label class="fuente-delgada" for="cedula">Horario</label>
                       <asp:TextBox CssClass="inicioSesion" ID="horario" runat="server"></asp:TextBox>
                    </div>
                  <br />
                  <br />
                  <asp:Button ID="ingresar" runat="server" Text="Ingresar" CssClass="button" OnClick="ingresar_Click" />
                   <br />
                   <asp:Button ID="borrarJornada" runat="server" Text="Borrar jornada" CssClass="button-blanco" OnClick="borrarJornada_Click" />
                  <br />
