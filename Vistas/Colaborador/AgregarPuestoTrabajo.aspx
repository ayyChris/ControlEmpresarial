<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgregarPuestoTrabajo.aspx.cs" Inherits="ControlEmpresarial.Vistas.Colaborador.AgregarPuestoTrabajo" MasterPageFile="~/Vistas/Site3.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            <section class="seccion-formulario">
               <div class="tarjeta-formulario-login" style="max-width: 700px; margin: 0 auto;">
                ...
                <asp:GridView ID="gridPuestos" runat="server" AutoGenerateColumns="False">
                    <Columns>
                        <asp:BoundField DataField="nombrePuesto" HeaderText="Puestos de Trabajos" />
                    </Columns>
                </asp:GridView>
            </div>
        </div>
