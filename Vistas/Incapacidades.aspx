<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Incapacidades.aspx.cs" Inherits="ControlEmpresarial.Vistas.Incapacidades" %>
    ...
    <form id="form1" runat="server">
       ...
       <main>
            <section class="seccion-formulario">
                ...
                <p>Registre una incapacidad de un empleado.</p>
                    ...
                    <textarea id="motivo" placeholder="Ingrese el motivo de la incapacidad."></textarea>
