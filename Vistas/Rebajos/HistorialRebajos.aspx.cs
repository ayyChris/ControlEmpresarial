...
{
    public partial class HistorialRebajos : System.Web.UI.Page
    {
        ...
        private void CargarRebajosPendientes()
        {
            ...
            {
                MySqlCommand cmd = new MySqlCommand("SELECT idRebajo, idEmpleado, TipoRebajoID, Fecha, Estado, Motivo, Monto FROM rebajo", conexion);
