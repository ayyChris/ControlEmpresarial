<%@ Page EnableEventValidation="true" Language="C#" AutoEventWireup="true" CodeBehind="TablePreAceptacionActividadColaborador.aspx.cs" Inherits="ControlEmpresarial.Vistas.Control_de_Actividades.TablePreAceptacionJefatura" %>
<!DOCTYPE html>
                ...
                <div class="table-container">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Acción">
                            <ItemTemplate>
                                <asp:Button ID="btnAccion" runat="server" Text="Solicitar" CommandName="Accion" CommandArgument='<%# Container.DataItemIndex %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                    </asp:GridView>
