<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ControladorHorasExtraSupervisor.aspx.cs" Inherits="ControlEmpresarial.Vistas.Horas_Extra.ControladorHorasExtraSupervisor" MasterPageFile="~/Vistas/Site3.master" %>
        ...
        <section class="seccion-formulario">
            <div class="tarjeta-formulario" style="max-width: 700px; margin: 0 auto;">
                ...
                <div class="main-content">
                    <!-- Sección de Horas Extra del Semana -->
